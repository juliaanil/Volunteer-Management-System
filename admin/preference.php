...
<div class="card shadow mb-4">
    ...
    <!-- <div class="card-body"> -->
        ...
        if(isset($_POST["submit"]))
        {
            ...
            $sql4 = "SELECT COUNT(*) AS count1 FROM tbl_payment WHERE pstatus IN ('pending', 'paid') AND pdate BETWEEN '$prev_date' AND '$next_date'";
            $result4 = $db->query($sql4);
            
            $sql5 = "SELECT COUNT(*) AS count2 FROM tbl_payment WHERE pstatus = 'donation' AND pdate BETWEEN '$prev_date' AND '$next_date'";
