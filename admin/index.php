...
$total_volunteers = mysqli_num_rows($db->query("select * from tbl_volunteer"));
$total_organizations = mysqli_num_rows($db->query("select * from tbl_organization"));
$total_events = mysqli_num_rows($db->query("select * from tbl_event"));
$total_donations = mysqli_num_rows($db->query("select * from tbl_payment where pstatus='donation'"));
$sql = "SELECT SUM(obalance) FROM tbl_organization";
$result = $db->query($sql);
...
$sql2 = "SELECT SUM(pamt) FROM tbl_payment";
...
$sql3 = "SELECT edescription FROM tbl_event WHERE ereqno = (SELECT MAX(ereqno) FROM tbl_event)";
...
$sql4 = "SELECT COUNT(*) AS count1 FROM tbl_payment WHERE pstatus IN ('pending', 'paid')";
$result4 = $db->query($sql4);

// Count rows with pstatus as 'donation'
$sql5 = "SELECT COUNT(*) AS count2 FROM tbl_payment WHERE pstatus = 'donation'";
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        <div class="text-sm font-weight-bold text-primary text-uppercase mb-1">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_remuneration;echo "Rs";?></div>
                                        </div>
                                        <div class="col-auto">
                                        <i class="fas fa-money-bill"></i>
