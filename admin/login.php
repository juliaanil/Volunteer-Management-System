...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    if(isset($_POST['login']))
    {
        ...
        if($aemail != "" && $apswd !="")
        {
                $resultset = $db->query("Select * from tbl_admin where aemail='$aemail' ");
...
<form method="POST" action="">
    <div class="container">
                        ...
                        <!--<div class="row"> -->
                           ...
                           <!-- <div class="col-lg-6"> -->
                                <div class="p-5">
                                    ...
                                    <h2 class="h4 text-black font-bold mb-4 uppercase tracking-wide">Admin Login</h2>
                                        <h1 class="h4 text-gray-900 mb-4">Volunteer Management for Non-Profits and Community Groups</h1>
                                        <br>
                                    </div>
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="email" name="aemail" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter email-id...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="apswd" class="form-control form-control-user"
        ...
        <!-- <p style="text-align:center;"><a style="color: blue;" href="register1.php">No account yet! Click Here to register</a></p> -->
                                    </input>
