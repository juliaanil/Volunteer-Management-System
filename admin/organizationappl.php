    ...
    <script type="text/javascript">
        ...
        function multipleSelect(clickedid) {
            ...
            if(clickedid=='delete_multiple') {
                ...
                window.location.href = "multiple-select1.php?checked="+arr+"&item=approved";
            }
            else if(clickedid=='mark-rejected') {
                // if(confirm("Are you sure you want to change the status to Inactive?")==true)
                window.location.href = "multiple-select1.php?checked="+arr+"&item=rejected";
            }
...
<h1 class="h3 mb-2 text-gray-800 text-center">Applications from organizations </h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php
                          ...
                          $sql1 = "SELECT * FROM tbl_organization WHERE ostatus = 'pending'";
                 ...
                 if ($result1->num_rows > 0) {$serial=1;;
                      ...
                      <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <td style="justify-content:center; text-align:center" width="5%"> 
                            <input  type="checkbox"  style="vertical-align:bottom;width:14px;height:15px" class="checkbox-child" name="check_list[]"  value=<?php echo $row['oid']; ?> >
                        ...
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["odescription"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["ocontactname"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["ophone"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["oemail"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["oaddr"]; ?> </td>
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["ostatus"]; ?> </td>
                        <?php  $serial=$serial+1;?>
