...
<h1 class="h3 mb-2 text-gray-800 text-center">Registered volunteers </h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    <div class="card-body">
        <div class="table-responsive">
            ...
            $sql1 = "SELECT * FROM tbl_volunteer WHERE vstatus = 'approved' AND vname LIKE '%$search%'";
                ...
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    while ($row = $result1->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td style="justify-content:center; text-align:center" width="70%">
                                <?php echo $row["vgender"]; ?>
                            </td>
                            <td style="justify-content:center; text-align:center" width="10%">
                                <a href="interests.php?vid=<?php echo $row['vid'] ?>" style="background-color:white;"
  ...
  <span class="interest-symbol">&#9829;</span>
                        ...
                        <td style="justify-content:center; text-align:center" width="10%"> 
                            <a href="delete1.php?id=<?php echo $row['vid']; ?>" onclick="return confirm('Are you sure you want to remove this volunteer?')" 
