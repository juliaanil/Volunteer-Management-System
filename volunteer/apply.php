...
$eappliedno= $_SESSION['eappliedno'];
	...
	if (isset($_POST["submit"]))
	{
           ...
           $sql = "INSERT INTO tbl_payment (vid, eid, pdate, pamt, pstatus) VALUES ($vid, $eid, '$date', $ewage, '$pstatus')";
           ...
           $sql12 = "insert into tbl_activity(vid,eid,aystatus) values ($vid,$eid,'incomplete')";
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
										<form action="" method="POST">
                                            ...
                                            <div class="form-group">
												<label for="exampleInputEmail1">Would you like to donate the wage to the organization?</label><br>
                                               <td>
