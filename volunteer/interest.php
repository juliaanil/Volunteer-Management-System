...
$vid=$_SESSION["vid"];
 ...
 //   $sql1="select * from tbl_volunteerevents where vid=$vid";
									...
									<div class="card-body">
										<form action="" method="POST">
                                            <div class="form-group" style="display:flex">
                                                    ...
                                                    <div style="width:40%"><label for="exampleInputEmail1"><?php 
                                                  //   foreach ($f as $faculty)
                                                //  foreach ($et as $etype)

                                                //      {
                                                     
                                                //      $etype_sql = "select * from tbl_eventtype where etypeid = $etype";
                                                //      $etype_name = $db->query($etype_sql);
                                                //      while($etName = $etype_name->fetch_assoc())
                                                //      {
                                                //          $etypenname = $etName['etName'];
                                                ...
                                                if ($result1->num_rows > 0) {
                                                    while ($row = $result1->fetch_assoc()) {
                                                        $etypeid = $row["etypeid"];
                                                        $sql2 = "SELECT etypename FROM tbl_eventtype WHERE etypeid=$etypeid";
                                                        $result2 = $db->query($sql2);
                                                
                                                        if ($result2->num_rows > 0) {
                                                            $etypename = $result2->fetch_assoc()["etypename"];
                                                            // echo $row["etypeid"]; 
                                                            echo $etypename;
                                                            echo "<br/>";
                                                        }
                                            ...
                                            <a href="interestedit.php"><input type="button" value="Edit" class="btn btn-danger float-right" style="background-color: blue;"></a>
