...
<h1 class="h3 mb-2 text-gray-800 text-center">Events </h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        //     WHERE etypeid IN (
        //         SELECT etypeid
        //         FROM tbl_volunteerevents
        //         WHERE vid = $vid
        //     )
        // )
        // AND ereqno > eappliedno
        // AND ($currentYear - (SELECT vage FROM tbl_volunteer WHERE vid = $vid)) BETWEEN eagell AND eageul
        // AND EXISTS (
        //     SELECT *
        //     FROM tbl_activity
        //     WHERE tbl_activity.eid = tbl_event.eid
        //     AND tbl_activity.vid = $vid
        // )
        // AND estatus = 'incomplete'
        // AND eend > CURDATE()";
        $sql2 = "SELECT *,
    (SELECT pstatus
    FROM tbl_payment
    WHERE vid = $vid
    AND eid = tbl_event.eid) AS pstatus
FROM tbl_event
WHERE elid IN (
    SELECT elid
    FROM tbl_eventlist
...
AND eend > CURDATE()";
                 ...
                 if ($result1->num_rows > 0) {
                        ...
                        <tr>
                            ...
                            <th style="text-align:center;"><b>New Event</b></th>
                            <th style="text-align:center;"><b>Date</b></th>
                         
                            <th style="text-align:center;"><b>View</b></th>
                            <th style="text-align:center;"><b>Apply</b></th>
                        ...
                        <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row["estart"]; ?> </td>
                           ...
                           <td style="justify-content:center; text-align:center" width="10%"> <?php 
                    ...
                    ?>
                            ...
                            <a href="apply.php?eid=<?php echo $row['eid']?>"><i class="fas fa-user-plus" style="color:gray;"></i></a>
                        ...
                        if ($result2->num_rows > 0) {
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tbody>
                            <h6 class="h4 mb-2 text-gray-800 text-center">Applied Events</h6>

                                
                            
                            
                            <!-- &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspApplied events -->
                            <tr>
                                ...
                                <th style="text-align:center;"><b>View</b></th>
                                <th style="text-align:center;"><b>Compensation</b></th>
                            ...
                            <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row2["edescription"]; ?> </td>
                            <td style="justify-content:center; text-align:center" width="70%"> <?php echo $row2["estart"]; ?> </td>
                             
                               <td style="justify-content:center; text-align:center" width="10%"> 
                                <a href="view.php?eid=<?php echo $row2['eid']?>"  style="background-color:white;" class="btn btn-light a-btn-slide-text">
                                <span style="color:gray" class="glyphicon glyphicon-edit fas fa-info" aria-hidden="true"></span>
                                </a>
                            </td>
    ...
    <?php
    if ($row2["pstatus"] == "pending" || $row2["pstatus"] == "paid") {
        echo "Financial";
    } else {
        echo "Donation";
    }
...
<td style="justify-content:center; text-align:center" width="10%">
    <a href="cancel.php?eid=<?php echo $row2['eid']?>" class="btn btn-danger">
        <span class="fas fa-times-circle"></span>
        
    </a>
</td>
<!-- <td style="justify-content:center; text-align:center" width="10%">
    <a href="cancel.php?eid=<?php echo $row2['eid']?>&vid=<?php echo $row2['vid']?>" class="btn btn-danger">
        <span class="fas fa-times-circle"></span>
        Cancel
    </a>
</td> -->
