    ...
    font-family: Arial, sans-serif;
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Name</label></div>
                                                <div style="width:10%"> <label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $vname?></label></div>
											</div>
                                             <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Phone no</label></div>
                                                <div style="width:10%"> <label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $vphone?></label></div>
											</div>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Email</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column"  for="exampleInputEmail1"><?php echo $vemail?></label></div>
											</div>
                    
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Address</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $vaddr?></label> </div>
											</div>
                                            <?php
                                            $currentYear = date("Y");
                                            $age = $currentYear - $vage;
                                             ?>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Age</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $age?></label> </div>
											</div>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Gender</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $vgender?></label> </div>
											</div>
											</div>
											<div class="form-group">
												
											</div>
											<a href="volunteeredit.php"><input type="button" value="Edit" class="btn btn-danger float-right"></a>
										</form>
									</div>
								</div>
							</div>
