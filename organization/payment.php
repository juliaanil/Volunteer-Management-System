   ...
   
{
    ...
    $sql = "UPDATE tbl_payment SET pdate = CURDATE(), pstatus = 'paid' WHERE pid = $pid;";
									...
									<div class="card-body">
										<form action="" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="estart" class="form-control" placeholder="" required />
...
<form action="" method="POST">
    ...
    <!-- </form>
                                            ...
                                            <!-- <button name="submit" type="submit" class="btn btn-primary ml-3 float-right">pay</button> -->
                                            <button name="submit" type="submit" class="btn btn-primary btn-success ml-3 float-right">pay</button>

                                                <a href="activity.php"><input type="button" value="cancel" class="btn btn-danger float-right"></a>
											</div>
										</form>
									</div>
								</div>
