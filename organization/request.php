...
<h1 class="h3 mb-2 text-gray-800 text-center">Your requests</h1>
<div>
    <?php  
...
<div class="card shadow mb-4">
    ...
    <button type="submit" class="btn-sm btn-primary a-btn-slide-text">
        ...
        <span width=400><strong>Add new request</strong></span>
    </button>
</div>
    ...
    <div class="card-body" style="width:50%;">
        ...
        $sql1 = "SELECT * FROM tbl_request WHERE oid = $oid ";
