...
if ($result1->num_rows > 0) { 
	...
	if (isset($_POST["submit"]))
	{
           ...
           $sql = "insert into tbl_event(elid,oid,edescription,estart,eend,etime,elocation,eagell,eageul,ereqno,ewage) values ($elid,$oid,'$edescription','$estart','$eend','$etime','$elocation',$eagell,$eageul,$ereqno,$ewage)";
									...
									<div class="card-body">
										<form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onChange="getelname(this.value);" name="eltype" id="eltype" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="eventlist" id="eventlist" class="form-control" required>
													<option value="">Select</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="edescription" class="form-control" placeholder="" required />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus name="etime" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Location</label>
                                                <input type="text" autofocus name="elocation" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Minimum age for volunteer</label>
                                                <input type="number" autofocus name="eagell" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Maximum age for volunteer</label>
                                                <input type="number" autofocus name="eageul" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Required number of volunteers</label>
                                                <input type="number" autofocus name="ereqno" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
                                            <div class="form-group">
												<label for="exampleInputEmail1">Wage for the volunteer</label>
                                                <input type="number" autofocus name="ewage" class="form-control" placeholder="" required />
												<!--<p style = "color: red;"><?php echo $errMsg; ?></p>  --> 
											</div>
