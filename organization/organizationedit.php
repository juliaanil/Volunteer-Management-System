<?php 
	...
	{    
        ...
        $newoid=$_POST['oid']; 
        $newoname=$_POST['oname'];
        $newocontactname=$_POST['ocontactname'];
        $newophone = $_POST['ophone'];
        $newoemail=$_POST['oemail'];
     
        $newoaddr=$_POST['oaddr'];
        $newodescription=$_POST['odescription'];
      
           
        $sql = "UPDATE tbl_organization 
        SET oname = '$newoname', ocontactname = '$newocontactname', 
            ophone = '$newophone', oemail= '$newoemail', 
            oaddr = '$newoaddr', odescription = '$newodescription' 
        WHERE oid = '$oid'";

if ($db->query($sql) === TRUE) { 
    header("location: index.php");
    $_SESSION['msg'] = "Organization updated successfully!";
}
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
										...
										<form action="" method="POST">
                                            ...
                                            <input type="text" autofocus name="oname" class="form-control"  required value="<?php echo $oname; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Contact name</label>
                                            <input type="text" autofocus name="ocontactname" class="form-control"  required value="<?php echo $ocontactname; ?>"/>
											</div>
                                            <div class="form-group">
	                                        <label for="exampleInputEmail1">Phone no</label>
                                            <input type="number" name="ophone" class="form-control" required value="<?php echo $ophone; ?>"/>
                                            </div> 
                                            <div class="form-group">
											<label for="exampleInputEmail1">Email id</label>
                                            <input type="text" autofocus name="oemail" class="form-control"  required value="<?php echo $oemail; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Address</label>
                                            <input type="text" autofocus name="oaddr" class="form-control"  required value="<?php echo $oaddr; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">description</label>
                                            <input type="text" autofocus name="odescription" class="form-control"  required value="<?php echo $odescription; ?>"/>
											</div>
