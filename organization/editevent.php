<?php 
	...
	{    
            ...
            $newelid = $_POST['elid'];
            $newoid = $_POST['oid'];
            $newedescription = $_POST['edescription'];
            $newestart = $_POST['estart'];
            $neweend = $_POST['eend'];
            $newetime = $_POST['etime'];
            $newelocation = $_POST['elocation'];
            $neweagell = $_POST['eagell'];
            $neweageul = $_POST['eageul'];
            $newereqno = $_POST['ereqno'];
            $neweappliedno = $_POST['eappliedno'];
            $newewage = $_POST['ewage'];
            $newestatus = $_POST['estatus'];
      
           
        $sql = "UPDATE tbl_event 
        SET edescription = '$newedescription', estart = '$newestart', 
        eend = '$neweend', etime = '$newetime', 
        elocation = '$newelocation', ereqno = $newereqno, ewage = $newewage 
        WHERE eid = '$eid'";
								...
								<div class="card mt-4  bg-white	">
									...
									<div class="card-body">
										...
										<form action="" method="POST">
                                            ...
                                            <input type="text" autofocus name="edescription" class="form-control"  required value="<?php echo $edescription; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Start date</label>
                                            <input type="text" autofocus name="estart" class="form-control"  required value="<?php echo $estart; ?>"/>
											</div>
                                            <div class="form-group">
	                                        <label for="exampleInputEmail1">End date</label>
                                            <input type="text" name="eend" class="form-control" required value="<?php echo $eend; ?>"/>
                                            </div> 
                                            <div class="form-group">
											<label for="exampleInputEmail1">Time</label>
                                            <input type="text" autofocus name="etime" class="form-control"  required value="<?php echo $etime; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Location</label>
                                            <input type="text" autofocus name="elocation" class="form-control"  required value="<?php echo $elocation; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Required number of volunteers</label>
                                            <input type="number" autofocus name="ereqno" class="form-control"  required value="<?php echo $ereqno; ?>"/>
											</div>
                                            <div class="form-group">
											<label for="exampleInputEmail1">Wage for volunteer</label>
                                            <input type="number" autofocus name="ewage" class="form-control"  required value="<?php echo $ewage; ?>"/>
											</div>
											...
											<a href="events.php"><input type="button" value="Back" class="btn btn-danger float-right"></a>
                                            </div>
										</form>
									</div>
								</div>
