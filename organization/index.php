    ...
    font-family: Arial, sans-serif;
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Organization name</label></div>
                                                <div style="width:10%"> <label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $oname?></label></div>
											</div>
                                             <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Description</label></div>
                                                <div style="width:10%"> <label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $odescription?></label></div>
											</div>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Email</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column"  for="exampleInputEmail1"><?php echo $oemail?></label></div>
											</div>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Contact name</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column"  for="exampleInputEmail1"><?php echo $ocontactname?></label></div>
											</div>
                                           
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Phone number</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $ophone?></label> </div>
											</div>
                                            <div class="form-group" style="display:flex">
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1">Address</label></div>
                                                <div style="width:10%"><label>:</label></div>
                                                <div style="width:40%"><label class="column" for="exampleInputEmail1"><?php echo $oaddr?></label> </div>
											</div>
											</div>
